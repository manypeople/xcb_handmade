...
CPPSTD="-std=gnu++11"
XCBLIBS="-lrt -lm -ldl -lxcb -lxcb-image -lxcb-icccm -lxcb-keysyms -lxcb-randr -lasound -lGL -lX11 -lX11-xcb -lXrandr"
CPPFLAGS="-msse2 -pthread -I../iaca/include/ -DHANDMADE_INTERNAL=1 -DHANDMADE_SLOW=1"
